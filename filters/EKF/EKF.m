...
classdef EKF < handle
    ...
    methods
        %% function area
        function obj = EKF(P_, Q_, R_, function_f_, function_jf_, function_h_, function_jh_, init_)
            % matrix init
            obj.P = P_;
            obj.Q = Q_;
            obj.R = R_;
