...
if scenario == 1; load('sample data/real_exp_ideal.mat');
elseif scenario == 2; load('sample data/real_exp_kidnap.mat');
elseif scenario == 3; load('sample data/real_exp_missing.mat');
