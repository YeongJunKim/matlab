...
classdef DFIR < handle
   ...
   methods
       ...
       function r = DFIR_init(obj, h_size_, x_size_, z_size_, u_size_, function_f_, function_jf_, function_h_, function_jh_, init_state_)
           % size mapping
           obj.h_size = h_size_;
           obj.x_size = x_size_;
           obj.u_size = u_size_;
       ...
       function r = DFIR_run(obj, u_, z_, pj_, alpha_)
           if obj.is_init == "ok"
%                disp("debug");
%                disp(obj.x_pre);
